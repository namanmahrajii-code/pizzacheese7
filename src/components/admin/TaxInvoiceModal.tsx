...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .slip { width: 70mm; max-width: 100%; margin: 0 auto; color: #000; font-size: 12px; line-height: 1.5; overflow-wrap: anywhere; }
    .c { text-align: center; }
    ...
    .row { display: flex; flex-wrap: wrap; justify-content: space-between; gap: 2px 8px; font-size: 12px; }
    ...
    .iline { display: flex; flex-wrap: wrap; justify-content: space-between; gap: 2px 8px; font-size: 11px; }
